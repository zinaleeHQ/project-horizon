...
|---|---|---|---|---|
| **Epic 1** — HL7 Mapping Upgrade | Translation layer update for Partner Health System A HL7 feeds | 13 | Data Engineer (x2) | None |
...
| Item 09 — RCM platform API Compatibility | Review platform v2.4.1 parameter documentation + compatibility matrix | 3 | Data Engineer | None |
...
- [ ] Partner Health System A HL7 data drops resolved and verified — cure notice response delivered
...
| Item 06+16 — Claims Reconciliation Triage | Emergency reconciliation of 340 stuck claims ($420K) | 8 | Data Engineer + Finance | RCM platform API cert (Sprint 1) |
...
| Epic / Item | Work Package | SP | Owner Role | Dependency |
|---|---|---|---|---|
| **Epic 3** — Billing Reconciliation Dashboard | Data model design: RCM platform + billing feeds | 5 | Tech Lead + Data Eng | Epic 2 workflow stable |
...
| Item 12 — Orphaned Charge Reconciliation | Batch reconciliation process for rural site timeout charges | 5 | Data Engineer | RCM platform API cert |
| Item 18 — Onboarding Documentation | Update hospitalist onboarding guide — RCM platform manual workflow SOP | 2 | PM | Epic 2 complete |
...
|---|---|---|
| Item 08 — JCAHO Dashboard | JS:13, data dependency on stable RCM platform+EMR pipeline (available post-Sprint 3) | Schedule for PI+1 Sprint 1 |
