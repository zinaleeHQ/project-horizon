...
>
> Just here to see if I'm a match for your organization? For the quickest look at how I work, check out [the PROCESS page for Horizon](https://github.com/zinaleeHQ/project-horizon/blob/main/PROCESS.md).
